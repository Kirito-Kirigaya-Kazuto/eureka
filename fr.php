...
define("MASS_MESSAGE","Message groupé");
...
define("FORUM","Forum");
define("CHAT","Chat");
define("IMPRINT","Imprimer");
define("MORE_LINKS","Autre lien");
define("TOUR","Tour de jeu");


//ERRORS
define("USRNM_EMPTY","(Nom d'utilisateur vide)");
define("USRNM_TAKEN","(Nom d'utilisateur déjà utilisé.)");
define("USRNM_SHORT","(min. ".USRNM_MIN_LENGTH." caractères)");
define("USRNM_CHAR","(Cractères invalide)");
define("PW_EMPTY","(Mot de passe vide)");
define("PW_SHORT","(min. ".PW_MIN_LENGTH." caractères)");
define("PW_INSECURE","(Mot de passe non-sécurisé. Veuillez en choisir un plus sécurisé.)");
define("EMAIL_EMPTY","(Adresse Email vide)");
define("EMAIL_INVALID","(Adresse Email invalide)");
define("EMAIL_TAKEN","(Adresse Email déjà utilisé)");
define("TRIBE_EMPTY","<li>Choisissez une tribu.</li>");
define("AGREE_ERROR","<li>Vous devez accepter les règles du jeu et les conditions générales afin de vous inscrire.</li>");
define("LOGIN_USR_EMPTY","Entrez un nom d'utilisateur.");
...
define("USR_NT_FOUND","Nom n'existe pas.");
define("LOGIN_PW_ERROR","Le mot de passe est incorrect.");
...
define("REGISTER_CLOSED","Les inscriptions sont fermé. Vous ne pouvez pas vous enregistrer sur ce serveur.");
define("NAME_EMPTY","Insérez le nom");
define("NAME_NO_EXIST","Il n'y a pas d'utilisateur avec ce nom ");
